...
const RequestDocumentsView = ({ onClose }: RequestDocumentsViewProps) => {
  ...
  const toggleAll = () => {
    if (selected.length === requestableDocuments.length) {
      setSelected([]);
      setComments({});
    } else {
      setSelected(requestableDocuments.map((d) => d.id));
    }
  };
  ...
  return (
    <div>
      <div className="border-b px-6 py-3">
        ...
        <span className="text-sm text-foreground">Request Documents</span>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      placeholder="Add a specific instruction or comment for this document... (optional)"
                      value={comments[id] ?? ""}
